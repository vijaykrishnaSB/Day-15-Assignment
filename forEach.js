1.c) print the following details name,captial,flag using forEach function ?
...
let asiaregion = countries.forEach(countries => {
    console.log("countries",countries.name,"flag",countries.flag,"capital",countries.captial);
